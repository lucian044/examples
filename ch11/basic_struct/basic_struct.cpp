...
// The definition of a structure named 'Student'
// The name of the struct is also called the tag
// The definition tells the compiler what the structure is composed of
struct Student {
...
int main() {
  ...
  // Creating an instance of the Student data type
